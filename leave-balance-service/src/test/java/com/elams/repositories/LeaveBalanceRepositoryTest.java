...
class LeaveBalanceRepositoryTest {
	...
	@Test
	void testExistsByEmployeeId_positive()
	{ 
	LeaveBalance lb=new LeaveBalance();
    lb.setEmployeeId(1L);
    lb.setLeaveType(LeaveType.SICK);
    lb.setBalance(10.0);
    testEntityManager.persist(lb);
	boolean exists=leaveBalanceRepository.existsByEmployeeId(1L);
	assertTrue(exists);
	}
	
	@Test
	void testExistsByEmployeeId_negative()
	{ 
	...
	@Test
	void testDeleteByEmployeeID_positive()
	{
		LeaveBalance lb=new LeaveBalance();
	    lb.setEmployeeId(1L);
	    lb.setLeaveType(LeaveType.SICK);
	    ...
	    leaveBalanceRepository.deleteByEmployeeId(lb.getEmployeeId());
	    boolean exists=leaveBalanceRepository.existsByEmployeeId(1L);
		assertFalse(exists);
