...
//    }
    ...
    public  Double getLeaveBalance(@RequestParam("employeeId") Long employeeId,@RequestParam("leaveType") LeaveType leaveType) {
...
//	
	...
	@PostMapping("/create")
    public ResponseEntity<LeaveBalanceDTO> createLeaveBalance(@RequestParam("employeeId") Long employeeId,@RequestParam("leaveType") LeaveType leaveType,@RequestParam("balance") Double balance )
    {
		LeaveBalanceDTO dto=leaveBalanceService.createLeaveBalance(employeeId, leaveType,balance);
		return ResponseEntity.ok(dto);
	...
	@GetMapping("/all")
	public ResponseEntity<List<LeaveBalanceDTO>> getAllLeaveBalancesForEmployees(@RequestParam("employeeId") Long employeeId) {
	    List<LeaveBalanceDTO> dtoList = leaveBalanceService.getAllLeaveBalanceOfEmployee(employeeId);
